...
function Products() {
    return (
        <div className='w-auto max-h-fit pt-32 bg-white'>
             <h1 className='lg:text-4xl text-3xl mb-16 text-center font-semibold'>Stylish Everyday Essentials</h1>
            <div className='flex flex-col lg:flex-row items-center justify-center gap-8'>
                <Link to='/Products/Tshirt40s'>
                <div className='bg-gray-50 border hover:border-2 hover:scale-105 transition-all duration-700 flex flex-col justify-center items-center w-[40vh] h-[65vh] lg:h-[55vh]'>
                ...
                <div className='bg-gray-50 border hover:border-2 hover:scale-105 transition-all duration-700 flex justify-center items-center flex-col w-[40vh] h-[65vh] lg:h-[55vh]'>
