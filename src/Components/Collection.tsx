...
function Collection() {
  ...
  return (
    <div className='max-h-fit w-auto bg-white'>
          <div id='home' className='w-auto flex justify-center flex-col lg:flex-row gap-28 md:gap-32 lg:gap-40 overflow-hidden items-center max-h-fit pt-20 pb-16  md:h-[180vh] lg:h-screen bg-white'>
             <div>
                  <motion.h4 
      ...
      <div className='flex justify-center lg:items-start items-center flex-col'>
          <motion.h1
           ...
           animate={weekend}
           ref={ref1}   
          className='lg:text-5xl text-2xl md:text-4xl md:mb-12 mt-14 lg:ml-[70px] font-bold'>Featured <span className='opacity-55 text-[#333333]'>Categories</span></motion.h1>
          <motion.p
           initial={{opacity: 0, x : -35}}
           animate={weekend1}
           ref={ref}   
          className='lg:text-xl text-sm font-semibold hidden lg:flex md:text-2xl lg:ml-[70px] mt-5 '>
            All weather condition - Jacket - T-Shirt - Shirt - Shorts and many more.
            </motion.p>
            <motion.p
            initial={{opacity: 0, x : -35}}
            animate={weekend1}
